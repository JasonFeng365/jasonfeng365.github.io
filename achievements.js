...
const achievements_sections = [
	...
	},
	{
		...
		entries: [
			...
			{ timeframe: 'October 2025 - present', title: 'Problemsetter and Interview Prep Lecturer', subtitle: 'CodeSprint / UCLA ACM ICPC Chapter', backgroundGradient: ['rgba(255, 121, 129, 0.25)', 'rgba(255, 154, 223, 0.25)'], urls: [{url: "https://codesprintla.uclaacm.com/", title: "CodeSprint LA"}, {url: "https://jasonfeng365.github.io/challenges/?name=codesprint", title: "Original CodeSprint Problems"}, {url: "https://www.youtube.com/watch?v=5Ij_ivPaKMU", title: "Lecture: Computer Architecture Fundamentals"}, {url: "https://www.youtube.com/watch?v=XpExuyaSD_U", title: "Lecture: Concurrency Fundamentals"}], description: "I helped out with the 2026 edition of CodeSprint as a problemsetter. The brunt of my work within UCLA's ICPC chapter was the interview prep track, where I prepared live lectures for participants, along with organizing a first-ever interview prep crash course event with three original lectures and practice problems, and mock interviews for participants.", imageUrls: ["images/academia/interview_minecraft.jpg", "images/academia/ucla_cache.jpg"] },
